...
async function connectToWA() {
console.log("CONNECTING DARK_ALFHA_MD_V1 BOT👩‍💻...");
...
console.log('DARK_ALFHA_MD_V1 CONNECTED TO WHATSAPP ENJOY ✅')

let up = `
*[ •  DARK_ALFHA_MD_V1 - STARTED‎ • ]*
*╭┈───────────────•*
...
app.get("/", (req, res) => {
res.send("HEY, DARK_ALFHA_MD_V1 STARTED ✅");
});
